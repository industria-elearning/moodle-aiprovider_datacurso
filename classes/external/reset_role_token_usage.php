...
/**
 * External function to reset role token usage counters.
 *
 ...
 */
class reset_role_token_usage extends external_api {
    /**
    ...
    public static function execute(int $id): array {
        ...
        return credit_token_service::reset_role_token_usage((int)$params['id']);
    }
