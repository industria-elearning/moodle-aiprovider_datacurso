...
$string['datacurso:managetokenlimits'] = 'Управлять лимитами кредитов по пользователям и ролям';
...
$string['error_roletokenlimit_exists'] = 'Для выбранной роли уже существует лимит кредитов.';
$string['error_roletokenlimit_notfound'] = 'Лимит кредитов роли не найден.';
$string['error_usertokenlimit_available_exceeded'] = 'Запрошенные кредиты ({$a->requested}) превышают доступные для назначения кредиты ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Лимиты кредитов Datacurso по ролям';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Локально хранимые квоты токенов Datacurso по ролям.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Метка времени начала учета использования квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Время последней синхронизации информации об использовании роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Метка времени следующей попытки периодического сброса квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Приоритет для разрешения конфликтов ролей (меньшее значение выше).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Включен ли периодический сброс для этого лимита роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Настроенная единица периодического интервала (час/день/неделя/месяц/год).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Настроенное значение периодического интервала для квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'ID роли, связанной с квотой.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Время создания записи квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Время последнего обновления записи квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Максимальное количество токенов, выделенных роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Токены, израсходованные пользователями в рамках этой квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Кэш использования по пользователям для ролевых квот токенов.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Время последней синхронизации использования пользователя для квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'Идентификатор записи квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Время создания записи кэша использования пользователя.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Время последнего обновления записи кэша использования пользователя.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Токены, израсходованные пользователем в окне квоты роли.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'ID пользователя, связанного с этим кэшем использования квоты роли.';
...
$string['roletokenlimit_add'] = 'Добавить лимит кредитов по роли';
$string['roletokenlimit_add_title'] = 'Добавить лимит кредитов по роли';
$string['roletokenlimit_edit_title'] = 'Изменить лимит роли: {$a}';
$string['roletokenlimit_priority'] = 'Приоритет';
$string['roletokenlimit_priority_help'] = 'Выберите уровень приоритета, который используется, когда пользователь попадает под несколько ролевых лимитов.';
$string['roletokenlimit_priority_high'] = 'Высокий';
$string['roletokenlimit_priority_invalid'] = 'Недопустимый уровень приоритета.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'Приоритет должен быть нулем или положительным числом.';
$string['roletokenlimit_priority_low'] = 'Низкий';
$string['roletokenlimit_priority_medium'] = 'Средний';
$string['roletokenlimit_role'] = 'Роль';
$string['roletokenlimit_saved'] = 'Лимит кредитов по роли сохранен';
$string['service'] = 'Сервис';
$string['showrows'] = 'Показать строки';
$string['task_reset_role_token_limits'] = 'Обрабатывать периодические сбросы лимитов токенов по ролям';
$string['task_reset_user_token_limits'] = 'Обработать периодические сбросы лимитов токенов пользователей';
$string['tokens'] = 'Кредиты';
$string['tokens_available'] = 'Доступные кредиты';
$string['tokens_to_assign'] = 'Кредиты для назначения';
...
$string['usertokenlimit_assignedtotal'] = 'Всего назначенных кредитов';
$string['usertokenlimit_availabletoassign'] = 'Доступные для назначения кредиты';
...
$string['usertokenlimit_licensebalance'] = 'Общий баланс кредитов лицензии';
$string['usertokenlimit_limit'] = 'Лимит кредитов';
$string['usertokenlimit_limit_help'] = 'Введите максимальное количество кредитов, которое пользователь может израсходовать. Используйте 0, чтобы заблокировать доступ к ИИ для этого пользователя.';
$string['usertokenlimit_limit_invalid'] = 'Лимит должен быть равен нулю или быть положительным числом.';
$string['usertokenlimit_limit_invalid_nonnegative'] = 'Лимит должен быть равен нулю или быть положительным числом.';
$string['usertokenlimit_recurringenabled'] = 'Включить периодический интервал';
$string['usertokenlimit_recurringenabled_help'] = 'Включает автоматический периодический сброс квоты для этого пользователя.';
$string['usertokenlimit_recurringinterval'] = 'Периодический интервал';
$string['usertokenlimit_recurringinterval_help'] = 'Количество дней, после которых квота пользователя сбрасывается и назначается заново. Используйте 0, чтобы отключить периодический сброс.';
$string['usertokenlimit_recurringinterval_invalid'] = 'Периодический интервал должен быть равен нулю или быть положительным числом дней.';
$string['usertokenlimit_recurringunit'] = 'Единица времени';
$string['usertokenlimit_recurringunit_day'] = 'Дни';
$string['usertokenlimit_recurringunit_help'] = 'Единица времени для периодического интервала (часы, дни, недели, месяцы, годы).';
$string['usertokenlimit_recurringunit_hour'] = 'Часы';
$string['usertokenlimit_recurringunit_invalid'] = 'Недопустимая единица периодического интервала.';
$string['usertokenlimit_recurringunit_month'] = 'Месяцы';
$string['usertokenlimit_recurringunit_week'] = 'Недели';
$string['usertokenlimit_recurringunit_year'] = 'Годы';
$string['usertokenlimit_recurringvalue'] = 'Значение интервала';
$string['usertokenlimit_recurringvalue_help'] = 'Числовое значение для выбранной единицы времени. Должно быть больше 0 при включении.';
$string['usertokenlimit_recurringvalue_invalid_positive'] = 'Значение интервала должно быть больше 0, когда периодический интервал включен.';
