...
$string['forbidden'] = 'You are not allowed to perform this action with the current license. Please verify your license and available credits in <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Tokens Manager</a>.';
...
$string['invalidlicensekey'] = 'License key has expired or is invalid. Please go to <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Shop Datacurso</a> to renew or purchase a new license.';
$string['jsondecodeerror'] = 'Error processing response from Datacurso API: {$a}';
$string['last_sent'] = 'Last sent';
$string['license_not_allowed'] = 'Your license is not allowed to perform this request. Please manage your licenses and credits in <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Tokens Manager</a>.';
...
$string['notenoughtokens'] = 'Insufficient AI credits. Please visit <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Tokens Manager</a> to allocate or purchase more credits. Or contact your administrator.';
...
$string['tokensnotsufficient'] = 'Insufficient AI credits. Current balance: {$a->current}. Minimum required: {$a->required}. Please visit <a href="https://shop.datacurso.com/index.php?m=tokens_manager" target="_blank">Tokens Manager</a> to allocate or purchase more credits. Or contact your administrator.';
