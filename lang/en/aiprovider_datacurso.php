...
$string['datacurso:managetokenlimits'] = 'Manage per-user and per-role credit limits';
...
$string['error_roletokenlimit_exists'] = 'A credit limit already exists for the selected role.';
$string['error_roletokenlimit_notfound'] = 'Role credit limit record not found.';
$string['error_usertokenlimit_available_exceeded'] = 'Requested credits ({$a->requested}) exceed currently available credits to assign ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Datacurso per-role credits limits';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Per-role Datacurso token quotas stored locally.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Timestamp marking when the role quota started tracking usage.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Last time role usage information was synchronised.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Timestamp for the next recurring role quota reset attempt.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Priority used to resolve role conflicts (lower wins).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Whether recurring reset is enabled for this role limit.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Configured recurring interval unit (hour/day/week/month/year).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Configured recurring interval value for the role quota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'Role ID associated with the quota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Time when the role quota record was created.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Time when the role quota record was last updated.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Maximum number of tokens granted to the role.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Tokens consumed by users covered by this role quota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Per-user usage cache associated with role token quotas.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Last time user usage for the role quota was synchronised.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'Role quota record identifier.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Time when the user usage cache record was created.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Time when the user usage cache record was last updated.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Tokens consumed by the user within the role quota window.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'User ID associated with this role quota usage cache.';
...
$string['privacy:metadata:aiprovider_datacurso_userlimit:nextresetat'] = 'Timestamp for the next recurring quota reset attempt.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervaldays'] = 'Recurring interval in days to attempt quota reset and reassignment.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalenabled'] = 'Whether recurring reset is enabled for this user limit.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalunit'] = 'Configured recurring interval unit (hour/day/week/month/year).';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalvalue'] = 'Configured recurring interval value.';
...
$string['roletokenlimit_add'] = 'Add role credit limit';
$string['roletokenlimit_add_title'] = 'Add role credit limit';
$string['roletokenlimit_edit_title'] = 'Edit role limit: {$a}';
$string['roletokenlimit_priority'] = 'Priority';
$string['roletokenlimit_priority_help'] = 'Select the priority level used when a user matches multiple role limits.';
$string['roletokenlimit_priority_high'] = 'High';
$string['roletokenlimit_priority_invalid'] = 'Invalid priority level.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'Priority must be zero or a positive number.';
$string['roletokenlimit_priority_low'] = 'Low';
$string['roletokenlimit_priority_medium'] = 'Medium';
$string['roletokenlimit_role'] = 'Role';
$string['roletokenlimit_saved'] = 'Role credit limit saved';
$string['second'] = 'second';
$string['seconds'] = 'Seconds';
$string['service'] = 'Service';
$string['showrows'] = 'Show rows';
$string['task_reset_role_token_limits'] = 'Process recurring role token limit resets';
$string['task_reset_user_token_limits'] = 'Process recurring user token limit resets';
$string['tokens'] = 'Credits';
$string['tokens_available'] = 'Available Credits';
$string['tokens_to_assign'] = 'Credits to assign';
...
$string['usertokenlimit_availabletoassign'] = 'Available credits to assign';
