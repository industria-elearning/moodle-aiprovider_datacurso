...
$string['plugindesc_assign_ai'] = 'Meninjau tugas dengan bantuan AI.';
$string['plugindesc_coursegen'] = 'Membuat kursus, aktivitas, dan sumber daya lengkap dengan AI.';
$string['plugindesc_datacurso_ratings'] = 'Memungkinkan siswa menilai aktivitas dan sumber daya; guru dan administrator dapat menghasilkan analisis kursus berbasis AI.';
$string['plugindesc_dttutor'] = 'Berinteraksi dengan tutor AI di dalam kursus.';
$string['plugindesc_forum_ai'] = 'Memperluas forum dengan analisis AI untuk menghasilkan ringkasan otomatis.';
$string['plugindesc_lifestory'] = 'Laporan dan analisis kemajuan akademik siswa dengan bantuan AI.';
$string['plugindesc_smartrules'] = 'Membuat aktivitas otomatis berdasarkan kondisi sebelumnya dari siswa.';
$string['plugindesc_socialcert'] = 'Menghasilkan sertifikat yang dipersonalisasi secara otomatis setelah menyelesaikan kursus.';
...
$string['pluginname_lifestory'] = 'Kisah Siswa AI';
$string['pluginname_smartrules'] = 'Aturan Pintar AI';
...
$string['privacy:metadata:datacurso_ai_services'] = 'Data yang dikirim ke layanan AI Datacurso untuk diproses.';
$string['privacy:metadata:datacurso_ai_services:request_data'] = 'Data yang dikirim ke layanan AI untuk diproses.';
$string['privacy:metadata:datacurso_ai_services:response_data'] = 'Respons yang diterima dari layanan AI.';
$string['privacy:metadata:datacurso_ai_services:timestamp'] = 'Kapan permintaan AI dibuat.';
$string['privacy:metadata:datacurso_ai_services:tokens_consumed'] = 'Jumlah token yang dikonsumsi dalam permintaan.';
$string['privacy:metadata:datacurso_ai_services:userid'] = 'ID pengguna yang membuat permintaan AI.';
