...
$string['datacurso:managetokenlimits'] = 'Gérer les limites de crédits par utilisateur et par rôle';
...
$string['error_roletokenlimit_exists'] = 'Une limite de crédits existe déjà pour le rôle sélectionné.';
$string['error_roletokenlimit_notfound'] = 'Limite de crédits par rôle introuvable.';
$string['error_usertokenlimit_available_exceeded'] = 'Les crédits demandés ({$a->requested}) dépassent les crédits actuellement disponibles à attribuer ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Limites de crédits Datacurso par rôle';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Quotas de jetons Datacurso par rôle stockés localement.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Horodatage indiquant le début du suivi de consommation du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Dernière synchronisation des informations d\'usage du rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Horodatage de la prochaine tentative de réinitialisation récurrente du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Priorité utilisée pour résoudre les conflits entre rôles (la plus faible gagne).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Indique si la réinitialisation récurrente est activée pour ce quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Unité de l\'intervalle récurrent configurée (heure/jour/semaine/mois/année).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Valeur configurée de l\'intervalle récurrent pour le quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'ID du rôle associé au quota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Date de création de l\'enregistrement du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Date de dernière mise à jour de l\'enregistrement du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Nombre maximal de jetons attribués au rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Jetons consommés par les utilisateurs couverts par ce quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Cache d\'usage par utilisateur associé aux quotas de jetons par rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Dernière synchronisation de l\'usage utilisateur pour le quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'Identifiant de l\'enregistrement du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Date de création de l\'enregistrement de cache d\'usage utilisateur.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Date de dernière mise à jour de l\'enregistrement de cache d\'usage utilisateur.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Jetons consommés par l\'utilisateur dans la fenêtre du quota de rôle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'ID utilisateur associé à ce cache d\'usage du quota de rôle.';
...
$string['roletokenlimit_add'] = 'Ajouter une limite de crédits par rôle';
$string['roletokenlimit_add_title'] = 'Ajouter une limite de crédits par rôle';
$string['roletokenlimit_edit_title'] = 'Modifier la limite du rôle : {$a}';
$string['roletokenlimit_priority'] = 'Priorité';
$string['roletokenlimit_priority_help'] = 'Sélectionnez le niveau de priorité utilisé lorsqu\'un utilisateur correspond à plusieurs limites de rôle.';
$string['roletokenlimit_priority_high'] = 'Élevée';
$string['roletokenlimit_priority_invalid'] = 'Niveau de priorité invalide.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'La priorité doit être égale à zéro ou un nombre positif.';
$string['roletokenlimit_priority_low'] = 'Faible';
$string['roletokenlimit_priority_medium'] = 'Moyenne';
$string['roletokenlimit_role'] = 'Rôle';
$string['roletokenlimit_saved'] = 'Limite de crédits par rôle enregistrée';
$string['service'] = 'Service';
$string['showrows'] = 'Afficher les lignes';
$string['task_reset_role_token_limits'] = 'Traiter les réinitialisations récurrentes des limites de jetons par rôle';
$string['task_reset_user_token_limits'] = 'Traiter les réinitialisations récurrentes des limites de jetons par utilisateur';
$string['tokens'] = 'Crédits';
$string['tokens_available'] = 'Crédits disponibles';
$string['tokens_to_assign'] = 'Crédits à attribuer';
...
$string['usertokenlimit_availabletoassign'] = 'Crédits disponibles à attribuer';
