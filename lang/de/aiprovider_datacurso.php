...
$string['datacurso:managetokenlimits'] = 'Kreditlimits pro Benutzer und pro Rolle verwalten';
...
$string['error_roletokenlimit_exists'] = 'Fuer die ausgewaehlte Rolle existiert bereits ein Kreditlimit.';
$string['error_roletokenlimit_notfound'] = 'Rollen-Kreditlimit nicht gefunden.';
$string['error_usertokenlimit_available_exceeded'] = 'Angeforderte Kredite ({$a->requested}) überschreiten die derzeit verfügbaren zuweisbaren Kredite ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Datacurso-Kreditlimits pro Rolle';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Lokal gespeicherte Datacurso-Tokenkontingente pro Rolle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Zeitstempel, ab dem die Nutzung fuer das Rollenkontingent gezaehlt wird.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Zeitpunkt der letzten Synchronisierung der Rollennutzung.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Zeitstempel fuer den naechsten periodischen Reset des Rollenkontingents.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Prioritaet zur Konfliktaufloesung zwischen Rollen (niedriger gewinnt).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Ob periodisches Zuruecksetzen fuer dieses Rollenkontingent aktiviert ist.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Konfigurierte Intervall-Einheit (Stunde/Tag/Woche/Monat/Jahr).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Konfigurierter Intervallwert fuer das Rollenkontingent.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'Rollen-ID des Kontingents.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Zeitpunkt der Erstellung des Rollenkontingent-Datensatzes.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Zeitpunkt der letzten Aktualisierung des Rollenkontingent-Datensatzes.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Maximale Anzahl an Token fuer die Rolle.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Von Nutzern unter diesem Rollenkontingent verbrauchte Token.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Nutzungs-Cache pro Benutzer fuer Rollentokenkontingente.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Zeitpunkt der letzten Synchronisierung der Benutzernutzung fuer das Rollenkontingent.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'ID des Rollenkontingent-Datensatzes.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Zeitpunkt der Erstellung des Benutzernutzungs-Cache-Datensatzes.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Zeitpunkt der letzten Aktualisierung des Benutzernutzungs-Cache-Datensatzes.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Vom Benutzer innerhalb des Rollenkontingent-Fensters verbrauchte Token.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'Benutzer-ID dieses Rollenkontingent-Nutzungs-Cache.';
...
$string['roletokenlimit_add'] = 'Rollen-Kreditlimit hinzufuegen';
$string['roletokenlimit_add_title'] = 'Rollen-Kreditlimit hinzufuegen';
$string['roletokenlimit_edit_title'] = 'Rollenlimit bearbeiten: {$a}';
$string['roletokenlimit_priority'] = 'Prioritaet';
$string['roletokenlimit_priority_help'] = 'Waehlen Sie die Prioritaetsstufe aus, die gilt, wenn ein Benutzer mehreren Rollenlimits entspricht.';
$string['roletokenlimit_priority_high'] = 'Hoch';
$string['roletokenlimit_priority_invalid'] = 'Ungueltige Prioritaetsstufe.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'Prioritaet muss Null oder eine positive Zahl sein.';
$string['roletokenlimit_priority_low'] = 'Niedrig';
$string['roletokenlimit_priority_medium'] = 'Mittel';
$string['roletokenlimit_role'] = 'Rolle';
$string['roletokenlimit_saved'] = 'Rollen-Kreditlimit gespeichert';
$string['service'] = 'Dienst';
$string['showrows'] = 'Zeilen anzeigen';
$string['task_reset_role_token_limits'] = 'Periodische Zuruecksetzungen von Tokenlimits pro Rolle verarbeiten';
$string['task_reset_user_token_limits'] = 'Wiederkehrende Zurücksetzungen von Benutzer-Tokenlimits verarbeiten';
$string['tokens'] = 'Kredite';
$string['tokens_available'] = 'Verfügbare Kredite';
$string['tokens_to_assign'] = 'Zuzuweisende Kredite';
...
$string['usertokenlimit_availabletoassign'] = 'Verfügbare Kredite zur Zuweisung';
