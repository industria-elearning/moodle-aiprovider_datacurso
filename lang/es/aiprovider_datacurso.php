...
$string['datacurso:managetokenlimits'] = 'Gestionar límites de créditos por usuario y por rol';
...
$string['error_roletokenlimit_exists'] = 'Ya existe un límite de créditos para el rol seleccionado.';
$string['error_roletokenlimit_notfound'] = 'No se encontró el límite de créditos del rol.';
$string['error_usertokenlimit_available_exceeded'] = 'Los créditos solicitados ({$a->requested}) exceden los créditos actualmente disponibles para asignar ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Límites de créditos por rol de Datacurso';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Cuotas locales de tokens por rol para Datacurso.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Fecha desde la cual se contabiliza el consumo de la cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Última vez que se sincronizó la información de uso del rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Marca de tiempo del próximo intento de reinicio recurrente de cuota por rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Prioridad usada para resolver conflictos entre roles (menor valor gana).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Si el reinicio recurrente está habilitado para este límite de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Unidad configurada del intervalo recurrente (hora/día/semana/mes/año).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Valor configurado del intervalo recurrente para la cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'ID del rol al que pertenece la cuota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Momento en el que se creó el registro de cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Momento en el que se actualizó por última vez el registro de cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Número máximo de tokens asignados al rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Tokens consumidos por los usuarios cubiertos por esta cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Cache de uso por usuario asociada a cuotas de tokens por rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Última vez que se sincronizó el uso del usuario para la cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'Identificador del registro de cuota de rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Momento en el que se creó el registro de cache de uso por usuario.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Momento en el que se actualizó por última vez el registro de cache de uso por usuario.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Tokens consumidos por el usuario dentro de la ventana de cuota del rol.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'ID de usuario asociado a este cache de uso de cuota por rol.';
...
$string['privacy:metadata:aiprovider_datacurso_userlimit:nextresetat'] = 'Marca de tiempo del próximo intento de reinicio recurrente de cuota.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervaldays'] = 'Intervalo recurrente en días para intentar reiniciar y reasignar la cuota.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalenabled'] = 'Si el reinicio recurrente está habilitado para este límite de usuario.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalunit'] = 'Unidad configurada del intervalo recurrente (hora/día/semana/mes/año).';
$string['privacy:metadata:aiprovider_datacurso_userlimit:recurringintervalvalue'] = 'Valor configurado del intervalo recurrente.';
...
$string['roletokenlimit_add'] = 'Agregar límite de créditos por rol';
$string['roletokenlimit_add_title'] = 'Agregar límite de créditos por rol';
$string['roletokenlimit_edit_title'] = 'Editar límite de rol: {$a}';
$string['roletokenlimit_priority'] = 'Prioridad';
$string['roletokenlimit_priority_help'] = 'Seleccione el nivel de prioridad usado cuando un usuario coincide con varios límites por rol.';
$string['roletokenlimit_priority_high'] = 'Alta';
$string['roletokenlimit_priority_invalid'] = 'Nivel de prioridad no válido.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'La prioridad debe ser cero o un número positivo.';
$string['roletokenlimit_priority_low'] = 'Baja';
$string['roletokenlimit_priority_medium'] = 'Media';
$string['roletokenlimit_role'] = 'Rol';
$string['roletokenlimit_saved'] = 'Límite de créditos por rol guardado';
$string['second'] = 'segundo';
$string['seconds'] = 'Segundos';
$string['service'] = 'Servicio';
$string['showrows'] = 'Mostrar filas';
$string['task_reset_role_token_limits'] = 'Procesar reinicios recurrentes de límites de tokens por rol';
$string['task_reset_user_token_limits'] = 'Procesar reinicios recurrentes de límites de tokens por usuario';
$string['tokens'] = 'Créditos';
$string['tokens_available'] = 'Créditos disponibles';
$string['tokens_to_assign'] = 'Créditos por asignar';
...
$string['usertokenlimit_assignedtotal'] = 'Créditos totales asignados';
$string['usertokenlimit_availabletoassign'] = 'Créditos disponibles para asignar';
...
$string['usertokenlimit_licensebalance'] = 'Créditos totales de licencia';
$string['usertokenlimit_limit'] = 'Límite de créditos';
$string['usertokenlimit_limit_help'] = 'Ingrese el número máximo de créditos que el usuario puede consumir. Use 0 para bloquear el acceso a la IA para este usuario.';
$string['usertokenlimit_limit_invalid'] = 'El límite debe ser cero o un número positivo.';
$string['usertokenlimit_limit_invalid_nonnegative'] = 'El límite debe ser cero o un número positivo.';
$string['usertokenlimit_recurringenabled'] = 'Habilitar intervalo recurrente';
$string['usertokenlimit_recurringenabled_help'] = 'Habilita el reinicio automático recurrente de la cuota para este usuario.';
$string['usertokenlimit_recurringinterval'] = 'Intervalo recurrente';
$string['usertokenlimit_recurringinterval_help'] = 'Cantidad de días tras los cuales se reinicia y reasigna la cuota del usuario. Use 0 para desactivar el reinicio recurrente.';
$string['usertokenlimit_recurringinterval_invalid'] = 'El intervalo recurrente debe ser cero o un número positivo de días.';
$string['usertokenlimit_recurringunit'] = 'Unidad de tiempo';
$string['usertokenlimit_recurringunit_day'] = 'Días';
$string['usertokenlimit_recurringunit_help'] = 'Unidad usada para el intervalo recurrente (horas, días, semanas, meses, años).';
$string['usertokenlimit_recurringunit_hour'] = 'Horas';
$string['usertokenlimit_recurringunit_invalid'] = 'Unidad de intervalo recurrente no válida.';
$string['usertokenlimit_recurringunit_month'] = 'Meses';
$string['usertokenlimit_recurringunit_week'] = 'Semanas';
$string['usertokenlimit_recurringunit_year'] = 'Años';
$string['usertokenlimit_recurringvalue'] = 'Valor del intervalo';
$string['usertokenlimit_recurringvalue_help'] = 'Valor numérico para la unidad de tiempo seleccionada. Debe ser mayor que 0 cuando está habilitado.';
$string['usertokenlimit_recurringvalue_invalid_positive'] = 'El valor del intervalo debe ser mayor que 0 cuando el intervalo recurrente está habilitado.';
