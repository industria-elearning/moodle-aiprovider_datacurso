...
$string['datacurso:managetokenlimits'] = 'Gerenciar limites de créditos por usuário e por papel';
...
$string['error_roletokenlimit_exists'] = 'Já existe um limite de créditos para o papel selecionado.';
$string['error_roletokenlimit_notfound'] = 'Limite de créditos por papel não encontrado.';
$string['error_usertokenlimit_available_exceeded'] = 'Os créditos solicitados ({$a->requested}) excedem os créditos atualmente disponíveis para atribuir ({$a->available}).';
...
$string['link_roletokenlimits'] = 'Limites de créditos Datacurso por papel';
...
$string['privacy:metadata:aiprovider_datacurso_rolelimit'] = 'Cotas de tokens Datacurso por papel armazenadas localmente.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:countfrom'] = 'Carimbo de data/hora que marca quando a cota do papel começou a contabilizar uso.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:lastsync'] = 'Última sincronização das informações de uso do papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:nextresetat'] = 'Carimbo de data/hora da próxima tentativa de redefinição recorrente da cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:priority'] = 'Prioridade usada para resolver conflitos entre papéis (menor valor vence).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalenabled'] = 'Se a redefinição recorrente está habilitada para este limite por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalunit'] = 'Unidade de intervalo recorrente configurada (hora/dia/semana/mês/ano).';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:recurringintervalvalue'] = 'Valor do intervalo recorrente configurado para a cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:roleid'] = 'ID do papel associado à cota.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timecreated'] = 'Momento em que o registro de cota por papel foi criado.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:timemodified'] = 'Momento em que o registro de cota por papel foi atualizado pela última vez.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokenlimit'] = 'Número máximo de tokens concedidos ao papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit:tokensused'] = 'Tokens consumidos por usuários cobertos por esta cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage'] = 'Cache de uso por usuário associado às cotas de tokens por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:lastsync'] = 'Última sincronização do uso do usuário para a cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:rolelimitid'] = 'Identificador do registro de cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timecreated'] = 'Momento em que o registro de cache de uso por usuário foi criado.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:timemodified'] = 'Momento em que o registro de cache de uso por usuário foi atualizado pela última vez.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:tokensused'] = 'Tokens consumidos pelo usuário na janela da cota por papel.';
$string['privacy:metadata:aiprovider_datacurso_rolelimit_userusage:userid'] = 'ID do usuário associado a este cache de uso da cota por papel.';
...
$string['roletokenlimit_add'] = 'Adicionar limite de créditos por papel';
$string['roletokenlimit_add_title'] = 'Adicionar limite de créditos por papel';
$string['roletokenlimit_edit_title'] = 'Editar limite do papel: {$a}';
$string['roletokenlimit_priority'] = 'Prioridade';
$string['roletokenlimit_priority_help'] = 'Selecione o nível de prioridade usado quando um usuário corresponde a vários limites por papel.';
$string['roletokenlimit_priority_high'] = 'Alta';
$string['roletokenlimit_priority_invalid'] = 'Nível de prioridade inválido.';
$string['roletokenlimit_priority_invalid_nonnegative'] = 'A prioridade deve ser zero ou um número positivo.';
$string['roletokenlimit_priority_low'] = 'Baixa';
$string['roletokenlimit_priority_medium'] = 'Média';
$string['roletokenlimit_role'] = 'Papel';
$string['roletokenlimit_saved'] = 'Limite de créditos por papel salvo';
$string['service'] = 'Serviço';
$string['showrows'] = 'Mostrar linhas';
$string['task_reset_role_token_limits'] = 'Processar redefinições recorrentes de limites de tokens por papel';
$string['task_reset_user_token_limits'] = 'Processar reinicializações recorrentes de limites de tokens por usuário';
$string['tokens'] = 'Créditos';
$string['tokens_available'] = 'Créditos disponíveis';
$string['tokens_to_assign'] = 'Créditos por atribuir';
...
$string['usertokenlimit_assignedtotal'] = 'Créditos totais atribuídos';
$string['usertokenlimit_availabletoassign'] = 'Créditos disponíveis para atribuir';
...
$string['usertokenlimit_licensebalance'] = 'Créditos totais da licença';
$string['usertokenlimit_limit'] = 'Limite de créditos';
$string['usertokenlimit_limit_help'] = 'Informe o número máximo de créditos que o usuário pode consumir. Use 0 para bloquear o acesso à IA para este usuário.';
$string['usertokenlimit_limit_invalid'] = 'O limite deve ser zero ou um número positivo.';
$string['usertokenlimit_limit_invalid_nonnegative'] = 'O limite deve ser zero ou um número positivo.';
$string['usertokenlimit_recurringenabled'] = 'Habilitar intervalo recorrente';
$string['usertokenlimit_recurringenabled_help'] = 'Habilita a redefinição automática recorrente da cota para este usuário.';
$string['usertokenlimit_recurringinterval'] = 'Intervalo recorrente';
$string['usertokenlimit_recurringinterval_help'] = 'Quantidade de dias após os quais a cota do usuário será redefinida e reatribuída. Use 0 para desativar a redefinição recorrente.';
$string['usertokenlimit_recurringinterval_invalid'] = 'O intervalo recorrente deve ser zero ou um número positivo de dias.';
$string['usertokenlimit_recurringunit'] = 'Unidade de tempo';
$string['usertokenlimit_recurringunit_day'] = 'Dias';
$string['usertokenlimit_recurringunit_help'] = 'Unidade usada para o intervalo recorrente (horas, dias, semanas, meses, anos).';
$string['usertokenlimit_recurringunit_hour'] = 'Horas';
$string['usertokenlimit_recurringunit_invalid'] = 'Unidade de intervalo recorrente inválida.';
$string['usertokenlimit_recurringunit_month'] = 'Meses';
$string['usertokenlimit_recurringunit_week'] = 'Semanas';
$string['usertokenlimit_recurringunit_year'] = 'Anos';
$string['usertokenlimit_recurringvalue'] = 'Valor do intervalo';
$string['usertokenlimit_recurringvalue_help'] = 'Valor numérico para a unidade de tempo selecionada. Deve ser maior que 0 quando habilitado.';
$string['usertokenlimit_recurringvalue_invalid_positive'] = 'O valor do intervalo deve ser maior que 0 quando o intervalo recorrente estiver habilitado.';
